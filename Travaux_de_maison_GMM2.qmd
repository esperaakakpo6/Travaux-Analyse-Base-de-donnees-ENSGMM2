...
bank["Label"] = ["client_" + str(i+1) for i in range(len(bank))]
bank.index = bank["Label"]

# Variables quantitatives (colonnes 1 et 5 en R → index 0 et 4 en Python)
X_quanti = bank.iloc[:, [0, 4]]

# Variables qualitatives (2,3,4,6,7 en R → index 1,2,3,5,6)
X_quali = bank.iloc[:, [1, 2, 3, 5, 6]].astype("category")

# Base complète
bank_famd = pd.concat([X_quanti, X_quali], axis=1)
...
res_famd.fit(bank_famd)

#valeurs propres
res_famd.eig_

# Pour variabl quanti
print(res_famd.quanti_)

#Pour variable quali
print(res_famd.quali_)

#Pour modalité
print(res_famd.levels_)
